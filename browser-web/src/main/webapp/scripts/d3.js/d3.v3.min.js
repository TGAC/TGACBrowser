(function () {
  ...
  d3.functor = q, d3.rebind = function (a, b) {
    ...
    if (arguments.length === 1)while (++f < c)s(d = a[f]) && (e += (d - e) / ++g);
    else while (++f < c)s(d = b.call(a, a[f], f)) && (e += (d - e) / ++g);
  ...
  bu.style = function (a, b, c) {
    ...
    var h = bD([]), i = bo([]), j = bo([]);
    if (typeof a == "function")while (++c < d)g(e = this[c], a.call(e, e.parentNode.__data__, c));
  ...
  d3.layout = {}, d3.layout.bundle = function () {
    ...
    return a.tick = function () {
      ...
      s = [];
      if (typeof i == "function")for (b = 0; b < e; ++b)s[b] = +i.call(this, m[b], b);
  ...
  d3.geom.delaunay = function (a) {
    ...
    if (arguments.length < 5)if (arguments.length === 3)e = d = c, c = b;
    else {
