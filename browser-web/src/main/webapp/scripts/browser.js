...
function setNavPanel() {
    ...
    var border_right = (diff) + "px";

    jQuery("#nav_panel").animate({left: left}, {duration: 300, queue: false});
    jQuery("#nav_panel").animate({borderBottomWidth: height}, {duration: 300, queue: false});
    jQuery("#nav_panel").animate({borderLeftWidth: border_left}, {duration: 300, queue: false});
    jQuery("#nav_panel").animate({borderRightWidth: (border_right)}, {duration: 300, queue: false});
}
