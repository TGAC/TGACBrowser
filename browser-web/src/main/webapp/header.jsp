...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/scripts/jquery/js/jquery-3.5.1.min.js'/>"></script>
    <script type="text/javascript" src="<c:url value='/scripts/jquery/js/jquery-migrate-3.3.0.js'/>"></script>
