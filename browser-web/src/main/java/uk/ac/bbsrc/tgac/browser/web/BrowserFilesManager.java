 ...
 * @since 0.0.2
 */
public class BrowserFilesManager implements FilesManager {
  protected static final Logger log = LoggerFactory.getLogger(BrowserFilesManager.class);
  ...
  public File generateTemporaryFile(String prefix, String suffix, File baseDir) throws IOException {
    log.info("generateTemporaryFile");
  ...
  public File generateTemporaryFile(String prefix, String suffix) throws IOException {
    log.info("generateTemporaryFile 2");
...
//    SecurityProfile profile = type.getSecurityProfile();
  ...
  public boolean checkDirectory(File path, boolean attemptMkdir) throws IOException {
        boolean storageOk;
